...
export const PREMIUM_TIERS: {
...
}[] = [
    {
        ...
        duration: '30 days',
        features: [
            '1.25x XP Multiplier on all activities',
            '+5 Bonus XP per daily challenge',
            '3 Streak Shields per month',
            'Performance Summary (tests/avg)',
    ...
    },
    {
        ...
        duration: '30 days',
        features: [
            '1.5x XP Multiplier on all activities',
            '+10 Bonus XP per daily challenge',
            '4 Streak Shields per month',
            'Full Performance Insights + Charts',
            'Answer Explanations (wrong answers)',
    ...
    },
    {
        ...
        features: [
            ...
            '+20 Bonus XP per daily challenge',
            '5 Streak Shields per month',
            'Full Analytics Suite + Class Rank',
            'All Answer Explanations (every question)',
            'Weak Topic Identification + Focus Areas',
            'Score Trend Analysis',
            'All Bubble Themes + Exclusive',
            'All Profile Frames + Animated',
            'All Premium Badges + Diamond',
            'Exclusive Test Access',
