...
const tabs = [
  {
    ...
    image: '/images/preview/dashboard.webp',
  ...
  },
  {
    ...
    label: 'My Reports',
    icon: FileText,
    image: '/images/preview/myreports.webp',
  ...
  },
  {
    ...
    label: 'Practice Mode',
    icon: Zap,
    image: '/images/preview/study-notes.webp',
  ...
  },
  {
    ...
    icon: Trophy,
    image: '/images/preview/realtimechat.webp',
  ...
  },
  {
    ...
    label: 'Study Notes',
    icon: BookOpen,
    image: '/images/preview/practice-mode.webp',
...
export default function FeatureShowcase() {
  ...
  return (
    <section id="product-tour" className="relative py-20 sm:py-28 px-4 sm:px-6 overflow-hidden">
      {/* Background glow */}
